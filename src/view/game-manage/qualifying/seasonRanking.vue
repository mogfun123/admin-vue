...
<!-- table -->
   <el-table :data="tableData" border style="width: 100%"  >
           <el-table-column prop="startRanking" label="起始排名" width="100">
              </el-table-column>
               <el-table-column prop="endRanking" label="结束排名" width="100">
              </el-table-column>
    ...
    <el-dialog title="添加房间" v-model="dialogAddInfo" size="small" :modal-append-to-body = false>
      <div class="content">
        ...
        <el-form ref="form"  :model="form" :rules="rules" label-width="100px">
               <el-form-item label="起始排名">
                     <el-col :span="14">
                      <el-input v-model="form.startRanking" type="number"></el-input>
                      </el-col>
                </el-form-item>
                  <el-form-item label="结束排名">
                     <el-col :span="14">
                      <el-input v-model="form.endRanking"type="number"></el-input>
                      </el-col>
                </el-form-item>
        ...
        return {
         ...
         tableData:null,
          ...
          form: {
             ...
             endRanking:'',//结束排名
             startRanking:'',//起始排名
            rewardType:1,//奖励类型(0:头像 1:排名 2:周头衔 3:日头衔)
            danId: '',
          reward1PropId:'',
          reward1Size:'',
          reward2PropId:'',
        ...
        deleteActionFirst(index,row){
         ...
         queryLists(){
           ...
           ensureAction(){
                      ...
                      option.rewardType = 1//奖励类型(0:头像 1:排名 2:周头衔 3:日头衔)
