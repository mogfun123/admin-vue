...
<div style='display:inline-block'>
         <el-table
          ...
          align='left'
           ...
           style="width: 100%">
        <el-table-column prop="day" label="注册时间" min-width="300">
        </el-table-column>
          <el-table-column prop="channel" label="渠道" min-width="300">
        </el-table-column>
        <el-table-column 
          prop="totalUser"
          label="注册总量" 
        ...
        <el-table-column prop="tatalDevice" label="注册总设备量" min-width="300">
        </el-table-column>
...
//      vm.queryLists()
  ...
  methods: {
     beginDownExcl(title){
         ...
         title = title||'表格'
          this.exportLists('ApiregisterStatistic').then((res)=>{
  ...
  queryLists(val) {
      ...
      option.endTime = hsdateUtil(option.endTime)
        ...
        this.queryProperty('ApiregisterStatistic',option,function(data){
