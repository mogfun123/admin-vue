...
<div style='display:inline-block'>
        ...
        <el-table-column prop="recordDate"   sortable label="日期" min-width="180">
         ...
         <el-table-column prop="channel" label="渠道" min-width="150">
            ...
            <el-table-column prop="inverse7" label="7日"   sortable min-width="200">
        </el-table-column>
            <el-table-column prop="inverse15" label="15日"   sortable min-width="200">
        </el-table-column>
            <el-table-column prop="inverse30" label="30日"   sortable  min-width="200">
        </el-table-column>
      </el-table>
...
//      vm.queryLists()
  ...
  methods: {
     beginDownExcl(title){
         ...
         title = title||'表格'
          this.exportLists('ApiinverseStatistic').then((res)=>{
  ...
  queryLists(val) {
      ...
      option.endTime = hsdateUtil(option.endTime)
        ...
        this.queryProperty('ApiinverseStatistic',option,function(data){
