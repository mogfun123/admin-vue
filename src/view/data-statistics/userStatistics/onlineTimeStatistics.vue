...
<div style='display:inline-block'>
        ...
        <el-table-column prop="recordDate"
         ...
         label="渠道" min-width="150">
        </el-table-column>
        <el-table-column prop="online30M"
          sortable
           label="在线30分钟" min-width="200">
        </el-table-column>
        <el-table-column prop="online1H" label="在线1小时"
          sortable
           min-width="200">
        </el-table-column>
        <el-table-column prop="online2H" label="在线2小时"
          sortable
           min-width="200">
        </el-table-column>
      </el-table>
...
//      vm.queryLists()
  ...
  methods: {
     beginDownExcl(title){
         ...
         title = title||'表格'
          this.exportLists('ApionlineTimeStatistic').then((res)=>{
  ...
  queryLists(val) {
      ...
      option.endTime = hsdateUtil(option.endTime)
        ...
        this.queryProperty('ApionlineTimeStatistic',option,function(data){
