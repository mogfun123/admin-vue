...
<div style='display:inline-block'>
        ...
        <el-table-column prop="incrementCount"   sortable label="注册人数" min-width="150">
        </el-table-column>
        <el-table-column prop="rechargeCount"   sortable label="付费用户数" min-width="200">
        </el-table-column>
         <el-table-column prop="upValue" label="用户APRU"  sortable  min-width="150">
        </el-table-column>
         <el-table-column prop="retention1" label="次日留存率"  sortable  min-width="150">
        </el-table-column>
         <el-table-column prop="retention3" label="3日留存率"  sortable  min-width="150">
        </el-table-column>
       <!--  <el-table-column prop="retention3" label="3日留存率" min-width="150">
        </el-table-column> -->
        <el-table-column prop="retention7" label="7日留存率" min-width="150">
        </el-table-column>
         <el-table-column prop="retention15" label="15日留存率" min-width="150">
        </el-table-column>
        <el-table-column prop="retention30" label="30日留存率" min-width="150">
        </el-table-column>
      </el-table>
...
export default {
  ...
  methods: {
     beginDownExcl(title){
         ...
         title = title||'表格'    
          this.exportLists('ApisaveStatistic').then((res)=>{
  ...
  queryLists(val) {
      ...
      option.endTime = hsdateUtil(option.endTime)
        ...
        this.queryProperty('ApisaveStatistic',option,function(data){
