...
<div style='display:inline-block'>
         <el-table
          ...
          align='left'
           style="width: 100%">
        <el-table-column prop="recordDate" label="日期" min-width="180">
        </el-table-column>
        ...
        label="用户数"
         ...
         <el-table-column prop="devidCount" label="设备数" min-width="150">
        </el-table-column>
         <el-table-column prop="avgOnline" label="平均在线时长(分钟)" min-width="150">
        </el-table-column>
         <el-table-column prop="avgHand" label="平均参与牌局数" min-width="150">
        </el-table-column>
          <el-table-column prop="rechargeCount" label="新增用户付费数" min-width="150">
        </el-table-column>
...
export default {
  ...
  methods: {
     beginDownExcl(title){
         ...
         title = title||'表格'
          this.exportLists('ApiuserStatisticsnewUser').then((res)=>{
  ...
  queryLists(val) {
      ...
      option.endTime = hsdateUtil(option.endTime)
        ...
        this.queryProperty('ApiuserStatisticsnewUser',option,function(data){
